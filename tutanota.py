...
class TutanotaPlugin(plugin_base.BotPluginBase):
    ...
    def registration_action(self):
       ...
       # birth_year = str(birthdate[2])
        ...
        self.sleep(2)
        self.type('document.getElementsByClassName("icon svg-content-fg")[0].click()')
        self.type('document.getElementsByClassName("icon svg-content-fg")[1].click()')
        self.type('document.getElementsByClassName("limit-width noselect bg-transparent button-height")[0].click()')
        ...
        self.type('document.getElementsByClassName("limit-width noselect bg-transparent button-height full-width")[0].click()')
        self.sleep(4)
        self.type('document.getElementsByClassName("limit-width noselect bg-transparent button-width-fixed button-height")[0].click()')
        ...
        self.type('document.getElementsByClassName("button-content flex items-center login plr-button justify-center")[0].click()')
        ...
        return bot_core.RegistrationActionInstanceResult(self.get_user_profile_id(), True,"tutanota.com",selected_username,selected_password)
